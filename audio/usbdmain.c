...
extern unsigned char NOTES_pixel_data[];
...
int audio_main (void)
{
  ...
  LPC_TIM0->TCR = 1;					/* TC0 Enable */
	...
	GLCD_DisplayString(0,0,1, "     Audio Mode     ");
	GLCD_SetBackColor(White);
	GLCD_SetTextColor(Blue);
	GLCD_DisplayString(1,0,1, "Push Select to exit.");
	GLCD_DisplayString(2,0,1, "Use Potentiometer to");
	GLCD_DisplayString(3,0,1, "change Volume");

	GLCD_Bitmap(70, 104, 180, 151, NOTES_pixel_data);
